...
class Webhooks
{
    ...
    public function createSvixApp(?Options $options = null): Operations\CreateSvixAppResponse
    {
        ...
        $hookContext = new HookContext('CreateSvixApp', null, $this->sdkConfiguration->securitySource);
    ...
    public function deleteSvixApp(?Options $options = null): Operations\DeleteSvixAppResponse
    {
        ...
        $hookContext = new HookContext('DeleteSvixApp', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function generateSvixAuthURL(?Options $options = null): Operations\GenerateSvixAuthURLResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('POST', $url);
        $hookContext = new HookContext('GenerateSvixAuthURL', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
