...
class WaitlistEntries
{
     ...
     */
    public function createWaitlistEntry(?Operations\CreateWaitlistEntryRequestBody $request = null, ?Options $options = null): Operations\CreateWaitlistEntryResponse
    {
        ...
        $hookContext = new HookContext('CreateWaitlistEntry', null, $this->sdkConfiguration->securitySource);
     ...
     * @throws \Clerk\Backend\Models\Errors\SDKException
     */
    public function listWaitlistEntries(?Operations\ListWaitlistEntriesRequest $request = null, ?Options $options = null): Operations\ListWaitlistEntriesResponse
    {
        $baseUrl = $this->sdkConfiguration->getServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/waitlist_entries');
        $urlOverride = null;
        ...
        $hookContext = new HookContext('ListWaitlistEntries', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
